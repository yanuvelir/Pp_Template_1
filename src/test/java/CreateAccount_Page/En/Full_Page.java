...
public class Full_Page {
    ...
    @Parameters({"Difference_T2_1_En", "MockFile_T2_1_En", "RealFile_T2_1_En"})
    @Test(groups = {"test1"}, testName = "RealFile_T2_1_En")
    public void mainCode(String Difference_T2_1_En, String MockFile_T2_1_En, String RealFile_T2_1_En)
        ...
        driver.get(Full_Page_TestConfig.SIGN_UP_PAGE);
