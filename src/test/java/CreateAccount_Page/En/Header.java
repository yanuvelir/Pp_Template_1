...
public class Header {
    ...
    public void mainCode(String Difference_T3_En, String MockFile_T3_En, String RealFile_T3_En)
        ...
        try {
            File screenshotFile = header.getScreenshotAs(OutputType.FILE);
        ...
        BufferedImage image1 = ImageIO.read(new File(MockFile_T3_En));
        BufferedImage image2 = ImageIO.read(new File(RealFile_T3_En));
        ...
        if (brightnessDifference < 0.005) {
            ...
            File differenceFile = new File(Difference_T3_En);
